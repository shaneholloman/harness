...
// ListSuggestedLabels lists label suggestions for a pull request.
func (c *Controller) ListSuggestedLabels(
	ctx context.Context,
	...
	return c.labelSvc.ListSuggestions(ctx, pullreq.ID, filter)
}
